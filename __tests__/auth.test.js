...
describe(' Auth .........', () => {
  ...
  it('can list() allusers ______________ ', async () => {
    let user1 = { username: 'Aya', password: '1234' };
    let user2 = { username: 'Fatima', password: '1234' };
    let user3 = { username: 'Mai', password: '1234' };
  ...
  it('can sign up', async () => {
    let userInfo = { username: 'Aya', password: '1234' };
  ...
  it('can signin basicAuth ', async () => {
    ...
    let output = await mockRequest.post('/signin').auth('Aya', '1234');
